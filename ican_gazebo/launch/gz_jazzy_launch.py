...
def generate_launch_description():
    ...
    ican_gazebo = launch_ros.substitutions.FindPackageShare(
        package="ican_gazebo").find("ican_gazebo")
    ...
    # Use Unitree Go2 configs from the unitree_go2_sim package
    ...
    default_world_path = os.path.join(ican_gazebo, "worlds/turtlebot3_house.world")
    ...
    gz_sim = IncludeLaunchDescription(
        ...
        launch_arguments={
            'gz_args': [LaunchConfiguration('world'), ' -r']  # Use configured world and start unpaused
        }.items(),
    )
